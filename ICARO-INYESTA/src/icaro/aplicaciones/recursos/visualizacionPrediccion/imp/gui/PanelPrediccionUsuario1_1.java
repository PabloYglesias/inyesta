...
public class PanelPrediccionUsuario1_1 extends VentanaEstandar{
			 ...
			 */
			private NotificacionesEventosVisPrediccion usoAgente; //comunicaci�n con el agente (control)
			
			
			public PanelPrediccionUsuario1_1(ClaseGeneradoraVisualizacionPrediccion visualizador) {
				usoAgente = new NotificacionesEventosVisPrediccion(visualizador);
				initComponents();
		    ...
		    private void botonAccessActionPerformed(java.awt.event.ActionEvent evt) {
		    	...
		    	//else
		    	//	usoAgente.peticionPrediccion(textoUsr.getText(),textoPwd.getText());
