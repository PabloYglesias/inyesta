 ...
 */
public class NotificacionesEventosVisPrediccion_1 {
    ...
    public NotificacionesEventosVisPrediccion_1(ClaseGeneradoraVisualizacionPrediccion generadoraVis) {
...
//        identificadorAgenteaReportar = generadoraVisualizador.getNombreAgenteAReportar();
    ...
    public void notificacionCierreSistema() {
        ...
        if (identificadorAgenteaReportar == null) {
            ...
            try {
                //       nombreAgentePrediccion = visualizador.getNombreAgentePrediccion();
                //        usoAgenteControlador = (ItfUsoAgenteReactivo) ClaseGeneradoraRepositorioInterfaces.instance().obtenerInterfaz(nombreAgentePrediccion);
                itfUsoAgenteaReportar = (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO + identificadorAgenteaReportar);
        ...
        //   }
        //    if (tipoAgentePrediccion.equals(NombresPredefinidos.TIPO_REACTIVO)) {
        //       ItfUsoAgenteReactivo itfUsoAgente = (ItfUsoAgenteReactivo) itfUsoRepositorioInterfaces.obtenerInterfaz(NombresPredefinidos.ITF_USO + nombreAgentePrediccion);
    ...
    public void peticionPrediccion(String equipo1, String equipo2, String fecha) {
        ...
        /*
         ...
         // origen = "VisualizacionPrediccion1"  ( Nombre del recurso de visualizacion) y destino = nombreAgentePrediccion
         itfUsoAgente.aceptaEvento(new EventoRecAgte("autenticacion", InfoAutenticacion, nombredeEsteRecurso, nombreAgentePrediccion));
         }
         ...
         //} else if (tipoAgentePrediccion.equals(NombresPredefinidos.TIPO_COGNITIVO)) {

         //     ItfUsoAgenteCognitivo cognitivo = (ItfUsoAgenteCognitivo) itfUsoRepositorioInterfaces.obtenerInterfaz(NombresPredefinidos.ITF_USO + nombreAgentePrediccion);
         //    InfoPrediccionSinValidar sinValidar = new InfoPrediccionSinValidar(username, password);
         //     EventoRecAgte evento = new EventoRecAgte("", sinValidar, "Recurso:VisualizacionPrediccion", nombreAgentePrediccion);
         //     if (cognitivo != null) {
         ...
         System.out.println("Ha habido un error al enviar el usuario y el password al agente de Prediccion ");
         e.printStackTrace();
         }
         */
        enviarEventoaOtroAgente(new EventoRecAgte("prediccion", InfoPrediccion, identificadordeEsteRecurso, identificadorAgenteaReportar), identificadorAgenteaReportar);
