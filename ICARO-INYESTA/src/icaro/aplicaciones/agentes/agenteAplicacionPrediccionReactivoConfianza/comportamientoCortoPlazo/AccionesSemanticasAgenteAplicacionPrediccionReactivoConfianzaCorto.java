package icaro.aplicaciones.agentes.agenteAplicacionPrediccionReactivoConfianza.comportamientoCortoPlazo;
...
public class AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianzaCorto extends AccionesSemanticasAgenteReactivo {
    ...
    public void realizarPrediccion(InfoPrediccionValidada pPrediccion) {
        ...
        try {
            ...
            Logger.getLogger(AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianzaCorto.class.getName()).log(Level.SEVERE, null, ex);
        }
        //Pongo resultado
