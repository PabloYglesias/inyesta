package icaro.aplicaciones.agentes.agenteAplicacionPrediccionReactivoConfianza.comportamientoLargoPlazo;
...
public class AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianzaLargo extends AccionesSemanticasAgenteReactivo {
    ...
    public void realizarPrediccion(InfoPrediccionValidada pPrediccion) {
        ...
        try {
            ...
            Logger.getLogger(AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianzaLargo.class.getName()).log(Level.SEVERE, null, ex);
        }
        //Pongo resultado
