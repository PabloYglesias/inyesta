package icaro.aplicaciones.agentes.agenteAplicacionPrediccionReactivoConfianza.comportamientoExpertoEquipo;
...
public class AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianzaExperto extends AccionesSemanticasAgenteReactivo {
    ...
    public void realizarPrediccion(InfoPrediccionValidada pPrediccion) {
        ...
        try {
            ...
            Logger.getLogger(AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianzaExperto.class.getName()).log(Level.SEVERE, null, ex);
        }
        //Pongo resultado
