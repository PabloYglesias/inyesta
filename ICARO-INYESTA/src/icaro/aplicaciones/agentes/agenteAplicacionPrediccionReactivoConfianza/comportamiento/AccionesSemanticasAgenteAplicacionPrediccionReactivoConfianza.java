package icaro.aplicaciones.agentes.agenteAplicacionPrediccionReactivoConfianza.comportamiento;
...
public class AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianza extends AccionesSemanticasAgenteReactivo {
    ...
    public void realizarPrediccion(InfoPrediccionValidada pPrediccion) {
        ...
        try {
            ...
            Logger.getLogger(AccionesSemanticasAgenteAplicacionPrediccionReactivoConfianza.class.getName()).log(Level.SEVERE, null, ex);
        }
        //Pongo resultado
